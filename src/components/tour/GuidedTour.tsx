...
const TOUR_STEPS: TourStep[] = [
  {
    targetId: "tour-chat",
    title: "Command Room",
    description: "和你的 AI Assistant 团队对话、下达指令、查看进度。这是你的主要工作台。",
    placement: "bottom",
    navigateTo: "/app/chat",
  },
  {
    ...
    title: "Calendar",
    description: "查看日程安排，加入会议或选择文档参会模式。Assistant 会为每场会议提前做好准备。",
    placement: "bottom",
  },
  {
    targetId: "tour-doc",
    title: "Doc",
    description: "浏览和编辑 Assistant 自动生成的文档——会议纪要、Slides、提案等。",
    placement: "bottom",
  },
  {
    targetId: "tour-inbox",
    title: "Inbox",
    description: "处理 Assistant 等待你确认的任务，比如 CRM 更新、邮件发送等。",
    placement: "bottom",
  },
  {
    targetId: "tour-assistants",
    title: "Assistants",
    description: "查看和管理你的 AI Assistant 团队，调整他们的工作规则和知识库。",
    placement: "bottom",
  },
  {
    targetId: "tour-activity-log",
    title: "Activity Log",
    description: "实时查看 Assistant 的工作动态——他们正在分析什么、生成了什么、在等待你什么。",
    placement: "left",
    navigateTo: "/app/chat",
  },
];
