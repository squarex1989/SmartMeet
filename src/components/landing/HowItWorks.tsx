...
export function HowItWorks() {
  return (
    <section id="how" className="py-16 md:py-24 px-4 md:px-6 border-t border-[#1E1E1E]">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold tracking-tight text-[#EDEDED] text-center mb-10 md:mb-16">
          How it works
        </h2>
